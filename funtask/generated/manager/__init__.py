...
# sources: manager.proto, types.proto
...
class IncreaseWorkersRequest(betterproto.Message):
    ...
    other_args: "Args" = betterproto.message_field(2)


@dataclass(eq=False, repr=False)
class IncreaseWorkerRequest(betterproto.Message):
    args: "Args" = betterproto.message_field(1)


@dataclass(eq=False, repr=False)
class IncreaseWorkerResponse(betterproto.Message):
    worker: "Worker" = betterproto.message_field(1)


@dataclass(eq=False, repr=False)
class IncreaseWorkersResponse(betterproto.Message):
    worker: List["Worker"] = betterproto.message_field(1)
...
class DispatchFunTaskRequest(betterproto.Message):
    ...
    change_status: bool = betterproto.bool_field(3)
    timeout: Optional[float] = betterproto.float_field(
        4, optional=True, group="_timeout"
    )
    other_args: "Args" = betterproto.message_field(5)
...
class GetQueuedStatusResponse(betterproto.Message):
    status_report: "StatusReport" = betterproto.message_field(1)
